  ...
  return (
    <div style={styles.layout}>
      ...
      <Sidebar
        ...
        navItems={[{ id: 'requests', name: 'Requests', icon: <FaFileAlt />, path: '/requests-instructor' }]}
      />
      ...
      <main style={styles.main}>
        <div style={styles.topHeader}>
          ...
          <button className="go-back-btn" style={styles.goBackBtn} onClick={() => navigate('/requests-instructor')}>Go Back</button>
        </div>
